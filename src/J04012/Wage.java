...
public class Wage {
    ...
    public Wage(String hoVaTen, double luongCB, double ngayCong, String chucVu) {
        this.maNV = "NV01";
    ...
    public String toString() {
        return String.format("%s %s %.0f %.0f %.0f %.0f", this.maNV, this.hoVaTen, this.tienLuong, this.tienThuong,
